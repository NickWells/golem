...
// MakeActionFunc returns a function suitable for passing to the AddPostAction
// method of a param.ByName object
func (c *Counter) MakeActionFunc() param.ActionFunc {
	return func(source string, loc location.L, p *param.ByName, paramValues []string) error {
		if c.ParamCount == nil {
